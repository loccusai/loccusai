...
const ProposalsListPage = ({ onBack, proposals, onUpdateStatus, onDeleteProposal, onNavigateToBuilder, requestConfirmation }: ProposalsListPageProps) => {
                            ...
                            return (
                                <div key={p.id} className="proposal-item">
                                    ...
                                    <div className="proposal-item-actions">
                                        ...
                                        <button className="btn-icon btn-delete" title="Excluir Orçamento" onClick={() => requestConfirmation('Confirmar Exclusão', `Tem certeza que deseja excluir o orçamento para "${p.clientName}"?`, () => onDeleteProposal(p.id))}>
