...
const DashboardPage = ({ 
    ...
    if (viewingAnalysis) {
        return (
            <AnalysisResultDisplay result={viewingAnalysis} onGenerateProposal={onNavigateToProposalBuilder} onBackToHistory={() => setViewingAnalysis(null)} />
        )
    }
    ...
    <>
        <header className="dashboard-header">
            <div>
                 ...
                 <p className="form-description">Veja, gerencie e exporte suas análises passadas.</p>
            </div>
        ...
        <div className="card history-card">
            ...
            {filteredHistory.length > 0 ? (
                            ...
                            {item.status === 'pending' ? (
                                <>
                                    ...
                                    <div className="history-card-actions">
                                        ...
                                        <button className="btn-icon btn-delete" title="Excluir Análise" onClick={() => requestConfirmation('Confirmar Exclusão', 'Tem certeza que deseja excluir esta solicitação pendente?', () => onDeleteHistoryItem(item.id))}>
                                ...
                                <>
                                    <div className="history-card-header">
                                        ...
                                        <div className="proposal-actions-group">
                                            ...
                                            <button className="btn-icon btn-delete" title="Excluir Análise" onClick={() => requestConfirmation('Confirmar Exclusão', `Tem certeza que deseja excluir a análise de "${item.companyName}"?`, () => onDeleteHistoryItem(item.id))}>
                                                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path><line x1="10" y1="11" x2="10" y2="17"></line><line x1="14" y1="11" x2="14" y2="17"></line></svg>
                                            </button>
                                        </div>
                                    </div>
                ...
                <div className="empty-state">
                    ...
                    <p>Suas análises aparecerão aqui assim que forem geradas.</p>
                    <button className="btn-primary" onClick={onNavigateToApp} style={{ marginTop: '1.5rem', padding: '0.8rem 1.6rem', fontSize: '1rem' }}>
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>
                        <span>Criar minha primeira análise</span>
                    </button>
                </div>
            )}
        </div>
